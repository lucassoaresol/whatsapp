...
chatWorker.on('completed', (job) => {
  console.log(`✅ [Sucesso] [CHAT] Tarefa ID ${job.id} processada com sucesso.`);
...
messageWorker.on('completed', (job) => {
  console.log(`✅ [Sucesso] [MESSAGE] Tarefa ID ${job.id} processada com sucesso.`);
  console.log(`Detalhes do Job: ${JSON.stringify(job.data)}`);
});
...
voteWorker.on('completed', (job) => {
  console.log(`✅ [Sucesso] [VOTE] Tarefa ID ${job.id} processada com sucesso.`);
  console.log(`Detalhes do Job: ${JSON.stringify(job.data)}`);
});
